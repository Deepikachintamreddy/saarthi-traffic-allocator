...
Stages (each writes what the next reads):
    ...
    5b_impact    counterfactual evaluation + equity lens + confidence self-audit
...
STAGES = ["1_pipeline.py","2_models.py","3_network.py","4_ops.py","5_scenarios.py","5b_impact.py","6_dashboard.py"]
